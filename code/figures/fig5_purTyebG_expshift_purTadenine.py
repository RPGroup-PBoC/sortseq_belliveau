...
# load in purT files M9 glucose + adenine
data_dir = '../sortseq/20160707_purT_xylE_dgoR/'
fname = '20160710_purT_MG1655_M9glucose_adenine_mut1_4bins_summary.csv'
...
plt.tight_layout()
figname_out = 'fig5_purTyebG_expshift_purTadenine.pdf'
