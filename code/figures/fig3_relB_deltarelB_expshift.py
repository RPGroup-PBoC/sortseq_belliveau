...
data_dir = '../sortseq/20150513_relBWTRNAP_relBdeltaBE/'
fname = '20150513_relB_MG1655deltarelBE_M9glucose_na_mut1_4bins_summary.csv'
...
figname_out = 'fig3_relB_deltarelB_expshift.pdf'
