...
datadir = '../mass_spec/*/'
files = glob.glob(datadir+'*_dgoR_*summary.csv')
...
vals = np.random.uniform(0.985,1.015,size=len(yvals_TF))
...
plt.savefig(output+'fig7_dgoR_massspec_scatter.pdf', format='pdf')
