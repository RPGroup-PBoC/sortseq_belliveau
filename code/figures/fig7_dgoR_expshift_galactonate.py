...
fname_1 = '20160710_dgoR_MG1655_M9galactonate_na_mut1_4bins_summary.csv'
df1 = pd.read_csv(data_dir_1 + fname_1)
df1['position'] = df1['position']

data_dir_2 = '../sortseq/20160707_purT_xylE_dgoR/'
fname_2 = '20160710_dgoR_MG1655_M9galactonate_na_mut2_4bins_summary.csv'
df2 = pd.read_csv(data_dir_2 + fname_2)

data_dir_3 = '../sortseq/20160707_purT_xylE_dgoR/'
fname_3 = '20160710_dgoR_MG1655_M9galactonate_na_mut3_4bins_summary.csv'
...
figname_out = 'fig7_dgoR_expshfit_galactonate.pdf'
fig.savefig(output + figname_out, format='pdf')


# lets also save the values to a txt file; I want to compare between conditions

df[df['expshift']!=0].groupby(['position'])[['expshift']].mean().to_csv(output + 'fig7_dgoR_expshfit_galactonate.csv')
