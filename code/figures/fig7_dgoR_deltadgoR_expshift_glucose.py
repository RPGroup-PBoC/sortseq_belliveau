...
data_dir_1 = '../sortseq/20160902_purTdelta_dgoRdelta/'
fname_1 = '20160824_dgoR_MG1655deltadgoR_M9glucose_na_mut1_4bins_summary.csv'
df1 = pd.read_csv(data_dir_1 + fname_1)
df1['position'] = df1['position']

data_dir_2 = '../sortseq/20160902_purTdelta_dgoRdelta/'
fname_2 = '20160824_dgoR_MG1655deltadgoR_M9glucose_na_mut2_4bins_summary.csv'
df2 = pd.read_csv(data_dir_2 + fname_2)

data_dir_3 = '../sortseq/20160902_purTdelta_dgoRdelta/'
fname_3 = '20160824_dgoR_MG1655deltadgoR_M9glucose_na_mut3_4bins_summary.csv'
df3 = pd.read_csv(data_dir_3 + fname_3)

df = df1.append(df2)
df = df.append(df3)

# the first set of bp are just wild-type due to where the primer was.
# df = df[df.position>=9]
...
figname_out = 'fig7_dgoR_deltadgoR_expshift_glucose.pdf'
fig.savefig(output + figname_out, format='pdf')


# lets also save the values to a txt file; I want to compare between conditions

df[df['expshift']!=0].groupby(['position'])[['expshift']].mean().to_csv(output + 'fig7_dgoR_deltadgoR_expshift_glucose.csv')
