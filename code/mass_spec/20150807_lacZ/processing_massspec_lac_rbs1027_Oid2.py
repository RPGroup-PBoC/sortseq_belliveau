...
promoter = 'lacZ_Oid'
date = 20150807
WT_sequence = 'CAAAACTGCAG CTCGTATGTTGTGTGG GGCAGTGAGCGCAACGCAATT TCACACAGGAAA'
control_sequence = 'CAAAACTGCAG CTCGTATGTTGTGTGG AATCCCCCTAGGTGAACCATT TCACACAGGAAA'
strain = 'HG105deltalysA_ybcN<>3*1_RBS1027_lacI'
media = 'M9glucose'
...
df = pd.read_csv('../../data/mass_spec/20150807_rbs1027/proteinGroups.txt',
                 delimiter='	')
...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity RBS1027_Oid_L_H',
         'Intensity L RBS1027_Oid_L_H', 'Intensity H RBS1027_Oid_L_H',
         'Ratio H/L type', 'Ratio H/L RBS1027_Oid_L_H']]
