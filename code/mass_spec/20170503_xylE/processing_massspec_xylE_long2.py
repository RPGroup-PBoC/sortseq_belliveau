...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity longDNA_trial2',
         'Intensity L longDNA_trial2', 'Intensity H longDNA_trial2',
         'Ratio H/L type', 'Ratio H/L longDNA_trial2']]
