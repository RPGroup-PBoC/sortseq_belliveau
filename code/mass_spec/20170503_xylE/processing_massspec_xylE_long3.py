...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity longDNA_trial3',
         'Intensity L longDNA_trial3', 'Intensity H longDNA_trial3',
         'Ratio H/L type', 'Ratio H/L longDNA_trial3']]
