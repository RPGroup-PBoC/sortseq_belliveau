...
df['std_dev'] = np.exp((df['Ratio H/L variability [%] HG104_O3_L_H'] / 100))

# from MaxQuant output, I want to collect the following for each replicate:
df = df[['Protein IDs','Gene names','Peptides', 'Intensity HG104_O3_L_H',
         'Intensity L HG104_O3_L_H', 'Intensity H HG104_O3_L_H',
         'Ratio H/L type', 'Ratio H/L HG104_O3_L_H', 'std_dev']]
