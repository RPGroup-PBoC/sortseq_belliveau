...
media = 'M9glucose'
binding_additions = 'hypoxathine_50$\mu$M'
replicate = 1
...
df = pd.read_csv('../../data/mass_spec/20170506_purT_hypoxanthine_triplicate_analysis/proteinGroups.txt',
                 delimiter='	')
...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity trial1',
         'Intensity L trial1', 'Intensity H trial1',
         'Ratio H/L type', 'Ratio H/L trial1']]
