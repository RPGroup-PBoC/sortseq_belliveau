...
promoter = 'xylE_longDNA'
date = 20170422
WT_sequence = 'CAA AAC TGC AGC GGC AAT AGT ATT GTT TTT ATC AAT TTT GGA TAA TTA TCA CAA TTA AGA TCA CAG AAA AGA CAT TAC GTA AAC GCA TTG TAA AAA ATG ATA ATT GCC TTA ACT GCC TGA CAA TTC CAA CAT CAA TGC ACT GAT AAA AGA TCA GAA TGG TC'
control_sequence = 'CAA AAC TGC AGC GGC AAT AGT ATT GTT TTT ATC AAT TTT GGA TAA TTT AAC AAC AGA TAA AAT TGT ACG CCC AAT ATT TTT TAA TAA CTG AAT AGT GTA AGA CTT GCC TTA ACT GCC TGA CAA TTC CAA CAT CAA TGC ACT GAT AAA AGA TCA GAA TGG TC'
strain = 'MG1655deltalysA'
media = 'M9xylose'
binding_additions = 'xylose_5g/L'
replicate = 1
...
df = pd.read_csv('../../data/mass_spec/20170506_xylE_xylose_triplicate_analysis/proteinGroups.txt',
                 delimiter='	')
...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity longDNA_trial1',
         'Intensity L longDNA_trial1', 'Intensity H longDNA_trial1',
         'Ratio H/L type', 'Ratio H/L longDNA_trial1']]
