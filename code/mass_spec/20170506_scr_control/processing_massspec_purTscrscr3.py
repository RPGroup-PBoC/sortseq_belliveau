...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity scrscr_trial3',
         'Intensity L scrscr_trial3', 'Intensity H scrscr_trial3',
         'Ratio H/L type', 'Ratio H/L scrscr_trial3']]
