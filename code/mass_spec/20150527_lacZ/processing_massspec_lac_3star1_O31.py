...
strain = 'HG105deltalysA_ybcN<>3*1lacI'
media = 'M9glucose'
...
df = pd.read_csv('../../data/mass_spec/20150527_3star1_lacI/proteinGroups.txt',
                 delimiter='	')
...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity 3star1_O3_H_L',
         'Intensity L 3star1_O3_H_L', 'Intensity H 3star1_O3_H_L',
         'Ratio H/L type', 'Ratio H/L 3star1_O3_H_L']]
