...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity 3star1_Oid_L_H',
         'Intensity L 3star1_Oid_L_H', 'Intensity H 3star1_Oid_L_H',
         'Ratio H/L type', 'Ratio H/L 3star1_Oid_L_H']]
