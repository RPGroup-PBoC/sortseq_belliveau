...
df = df[['Protein IDs','Gene names','Peptides', 'Intensity 3star1_Oid_H_L',
         'Intensity L 3star1_Oid_H_L', 'Intensity H 3star1_Oid_H_L',
         'Ratio H/L type', 'Ratio H/L 3star1_Oid_H_L']]
